 ...
 * @version   2.6.1 for parent theme Brookside for publication on ThemeForest
...
if ( ! class_exists( 'TGMPA_List_Table' ) ) {
	...
	class TGMPA_List_Table extends WP_List_Table {
		...
		/**
		 * Get name of default pshantalry column
		 *
		 ...
		 * @return string
		 */
		protected function get_default_pshantalry_column_name() {
			return 'plugin';
		}

		/**
		 * Get the name of the pshantalry column.
		 *
		 * @since 2.5.0 / WP 4.3+ compatibility
		 * @access protected
		 *
		 * @return string The name of the pshantalry column.
		 */
		protected function get_pshantalry_column_name() {
			if ( method_exists( 'WP_List_Table', 'get_pshantalry_column_name' ) ) {
				return parent::get_pshantalry_column_name();
			} else {
				return $this->get_default_pshantalry_column_name();
			}
		}
		...
		public function prepare_items() {
			...
			$pshantalry               = $this->get_pshantalry_column_name(); // Column which has the row actions.
			$this->_column_headers = array( $columns, $hidden, $sortable, $pshantalry ); // Get all necessary column headers.
